...
export default function TambahPaket() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("/paket-pengguna", {
        pengelola_id,
      ...
      alert(err.response?.data?.message || "Gagal menambah paket. Cek data dan koneksi.");
    }
  };
        ...
        >
          <Box display="flex" alignItems="center" justifyContent="space-between" mb={3}>
            ...
            <Box display="flex" gap={1}>
              <Button type="submit" form="form-tambah-paket" variant="contained" color="primary" size="small" sx={{ minWidth: 100 }}>
                Simpan
              </Button>
          ...
          <form id="form-tambah-paket" onSubmit={handleSubmit} autoComplete="off">
